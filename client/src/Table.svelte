      ...
      {#each sizes as size, index}
        {#each product.variants
          ...
          <tr height="50">
            ...
            <td>{product.handle}
                  {#if viewimg && index < 1}
                  <img class="img" src="http://localhost:3000/static/{product.type.includes('Poleras') ? product.type === productsconfig.polera_H.name ? "polerahombre" : "poleramujer" : "poleronestodos"}/{variant.filename}" alt="xxx">
                  {/if}
                </td>
            ...
            {#if i < 1 && index < 1}
                <td>
                  ...
                  {:else}
                    {customDescription(product.title, product.type)}
                  {/if}
                </td>
              {:else}
                <td />
            ...
            {#if index < 1}
              ...
              {:else if index == 1 && i < 1}
                <td>
                  {#if product.type === productsconfig.polera_H.name} https://cdn.shopify.com/s/files/1/0489/5703/0565/files/med_polera_hombre.jpg
                  {:else if product.type === productsconfig.polera_M.name}https://cdn.shopify.com/s/files/1/0489/5703/0565/files/med_polera_mujer.jpg
                  {:else}https://cdn.shopify.com/s/files/1/0489/5703/0565/files/med_polerones_unisex.jpg
                  {/if}
                </td>
              {:else}
                <td />
